...
![The *Data parameters* box of the *Reduced dimension plot* panel, expanded to reveal its contents.](figures/data-parameters-reduced-dimension-plot.png){#fig-data-param-box-reddimplot}
