...
![The *Visual parameters* box of the *Reduced dimension plot* panel, expanded to reveal the 'Color', 'Shape', 'Size', and 'Facet' sections of its contents.](figures/visual-parameters-reduced-dimension-plot.png){#fig-visual-param-box-reddimplot width=400}
