...
The *Data parameters* collapsible box contains interactive elements that control aspects specific to each panel type.

For plots, that would typically be the choice of variables shown along each axis.

For tables, that would typically be the subset of columns displayed in the panel.
