...
::: {.callout-warning}
In the code chunk above, `SummarizedExperiment(...)` is pseudo-code that *represents* the creation of [*SummarizedExperiment*][bioc-summarizedexperiment]; do not run that code!
